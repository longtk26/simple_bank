...
type LoginUserResponse struct {
	...
	AccessTokenExpires  *timestamp.Timestamp   `protobuf:"bytes,3,opt,name=access_token_expires,json=accessTokenExpires,proto3" json:"access_token_expires,omitempty"`
	RefreshToken        string                 `protobuf:"bytes,4,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"`
	RefreshTokenExpires *timestamp.Timestamp   `protobuf:"bytes,5,opt,name=refresh_token_expires,json=refreshTokenExpires,proto3" json:"refresh_token_expires,omitempty"`
...
func (x *LoginUserResponse) GetAccessTokenExpires() *timestamp.Timestamp {
	if x != nil {
...
func (x *LoginUserResponse) GetRefreshTokenExpires() *timestamp.Timestamp {
	if x != nil {
